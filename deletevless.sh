...
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/vltls.json
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/vlntls.json

# Remove the corresponding JSON files
rm -rf /usr/local/etc/xray/backup/vless/$user-tls.txt
rm -rf /usr/local/etc/xray/backup/vless/$user-nontls.txt
rm -rf /usr/local/etc/xray/users/vless/$user-tls.json
rm -rf /usr/local/etc/xray/users/vless/$user-nontls.json
echo ""
