...
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/vmtls.json
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/vmntls.json

# Remove the corresponding JSON files
rm -rf /usr/local/etc/xray/backup/vmess/$user-tls.txt
rm -rf /usr/local/etc/xray/backup/vmess/$user-nontls.txt
rm -rf /usr/local/etc/xray/users/vmess/$user-tls.json
rm -rf /usr/local/etc/xray/users/vmess/$user-nontls.json
echo ""
